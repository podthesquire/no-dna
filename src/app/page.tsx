...
export default function Home() {
  return (
    <main className="mx-auto max-w-2xl px-6 py-16 font-mono text-sm leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="mb-4 text-lg font-bold">When set, CLIs should:</h2>
...
bool is_agent = (no_dna != NULL && no_dna[0] != '\\0');`}</code>
      ...
      <section className="mb-10">
        <h2 className="mb-4 text-lg font-bold">Adoption path</h2>
        <p className="mb-4 text-neutral-600">
          Most CLIs don&apos;t check for <code className="bg-neutral-100 px-1 text-sm">NO_DNA</code> yet. In the meantime,
          agent skill files (like <code className="bg-neutral-100 px-1 text-sm">SKILL.md</code> or tool definitions) should
          explicitly instruct agents to pass <code className="bg-neutral-100 px-1 text-sm">NO_DNA=1</code> when invoking CLIs:
        </p>
        <pre className="overflow-x-auto rounded-md bg-neutral-950 p-4 text-sm leading-snug text-neutral-200">
...
When running CLI commands, always prefix with NO_DNA=1:
  ...
  NO_DNA=1 surfpool start`}</code>
        ...
        <p className="mt-4 text-neutral-600">
          As adoption grows, agent frameworks will set <code className="bg-neutral-100 px-1 text-sm">NO_DNA=1</code> by
          default in their shell environments &mdash; just like CI runners set{' '}
          <code className="bg-neutral-100 px-1 text-sm">CI=true</code> today. Skill files won&apos;t need to mention it
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-neutral-600">
              <code className="bg-neutral-100 px-1 text-sm">CI=true</code> = non-interactive environment.{' '}
              <code className="bg-neutral-100 px-1 text-sm">NO_DNA</code> = non-human operator.
          ...
          <div>
            ...
            <p className="text-neutral-600">
              <code className="bg-neutral-100 px-1 text-sm">NO_COLOR</code> disables one output feature.{' '}
              <code className="bg-neutral-100 px-1 text-sm">NO_DNA</code> is broader: output format, interactivity,
      ...
      <footer className="border-t border-neutral-200 pt-6 text-neutral-400">
        <p>
          ...
          check for <code className="bg-neutral-100 px-1 text-sm text-neutral-600">NO_DNA</code> and do the right thing.
        </p>
      </footer>
    </main>
  );
